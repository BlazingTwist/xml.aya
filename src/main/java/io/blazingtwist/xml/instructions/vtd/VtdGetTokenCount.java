...
public class VtdGetTokenCount extends NamedOperator {
	public VtdGetTokenCount() {
		super("vtd.get_token_count", "(xml_id|xmlns_id)::num -> num : Get total number of VTD tokens for the XML document.");
	}

	@Override
	public void execute(BlockEvaluator blockEvaluator) {
		XmlInstance xml = InstanceManager.popInstance(this, blockEvaluator, InstanceType.Xml, InstanceType.Xmlns);
		pushValue(blockEvaluator, xml.getNav().getTokenCount());
	}
}